...
namespace Interview_Project.Migrations
{
    ...
    [Migration("20210428114231_RenameFKConstrainsInEmployeesTable")]
    partial class RenameFKConstrainsInEmployeesTable
    {
            ...
            modelBuilder.Entity("Interview_Project.Core.Domain.Employee", b =>
                {
                    ...
                    b.HasIndex(new[] { "Lname", "Fname", "Minit" }, "employees_ind")
                        .IsClustered();
